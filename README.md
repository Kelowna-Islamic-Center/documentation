...
- **Server-Side Cloud Functions** – for announcements timestamping and notifications.  
- **Mobile App** – end-user app for prayer times, prayer reminders, notifications, alerts, and admin tools.  
- **Kiosk App** – display app deployed on Masjid kiosk TV screens to show prayer times and announcements.
...
[![Read this Documentation](https://img.shields.io/badge/📚%20Read%20this%20Documentation-4CAF50?style=for-the-badge)](https://kelowna-islamic-center.github.io/documentation/)
